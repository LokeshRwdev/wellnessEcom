        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <Link href="/" className="flex items-center">
              <span className="text-2xl font-serif font-medium text-sage-800">
                SabrShukr
              </span>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <button
              aria-label="Search"
              className="p-2 hover:text-sage-600 transition-colors"
            >
              <Link href="/search">
                <FiSearch size={20} />
              </Link>
            ...
            <Link
              href="/cart"
              className="p-2 hover:text-sage-600 transition-colors relative"
            >
